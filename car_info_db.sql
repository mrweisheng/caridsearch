...
CREATE TABLE `car_brands`  (
  ...
  `brand_name_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '品牌英文名',
  `vehicle_count` int NULL DEFAULT 0 COMMENT '该品牌车辆数量',
  `is_active` tinyint NULL DEFAULT 1 COMMENT '是否启用：1=启用, 0=禁用',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_brand_name`(`brand_name` ASC) USING BTREE,
  INDEX `idx_is_active`(`is_active` ASC) USING BTREE,
  INDEX `idx_vehicle_count`(`vehicle_count` ASC) USING BTREE
...
CREATE TABLE `car_models`  (
  ...
  `model_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '车型名称',
  `model_name_normalized` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '标准化车型名称（去空格、统一大小写）',
  `vehicle_count` int NULL DEFAULT 0 COMMENT '该车型车辆数量',
  `is_active` tinyint NULL DEFAULT 1 COMMENT '是否启用：1=启用, 0=禁用',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_brand_model`(`brand_id` ASC, `model_name_normalized` ASC) USING BTREE,
  INDEX `idx_brand_id`(`brand_id` ASC) USING BTREE,
  INDEX `idx_is_active`(`is_active` ASC) USING BTREE,
  INDEX `idx_vehicle_count`(`vehicle_count` ASC) USING BTREE,
  CONSTRAINT `fk_models_brand` FOREIGN KEY (`brand_id`) REFERENCES `car_brands` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 6100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4026 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '每日访客统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `vehicle_images`  (
  ...
  `thumbnail_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '缩略图URL',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_vehicle_id`(`vehicle_id` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 171425 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '车辆图片表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `vehicles`  (
  ...
  `publish_status` tinyint NULL DEFAULT 1 COMMENT '发布状态：1=已发布, 2=草稿, 3=下架',
...
) ENGINE = InnoDB AUTO_INCREMENT = 39353 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '车辆基础信息表' ROW_FORMAT = DYNAMIC;
